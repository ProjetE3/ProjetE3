...
<head>
	...
	try{
		...
		$rep=$bdd->query("SELECT DATE_FORMAT(`DateHeureMinute`,'%H:%i') AS Jour, SUM(EnerCons) AS Energie_consomme, IdLumiere FROM (SELECT * FROM energie WHERE IdLumiere IS NOT NULL ORDER BY IdEner DESC LIMIT 5400) sub GROUP BY MINUTE(DateHeureMinute) ASC, IdLumiere ASC ORDER BY DateHeureMinute ASC, IdLumiere ASC;");
		...
		function drawChart() {
			var data = google.visualization.arrayToDataTable([
				['Temps', 'Lumiere Salon','Lumiere Chambre','Lumiere Cuisine', 'Total Lumieres'],<?php echo $chaine;?>
			]);

			var options = {
				//theme : 'material',
				chart: {title: 'Consommation de la lumiere par jour', subtitle:'en W/h'},
				//curveType:'function',
				width: 1500,
				height: 375,
		...
		function drawPie(){
			...
			var options2 = {
				title: 'Répartition des consommations des lumieres :',
	...
	<div id="main">
		<div class="titre">
			<br><h1>CONSOMMATION DE LA LUMIERE</h1><br>
		</div>
		...
		<div class="graph">
			...
			<div class="PiePrice">
				...
				<div class="Price">
					...
					<h1>Coût total des lumieres sur 30 jours :</h1>
					<br /><br /><br />
					<p><?php echo "~".number_format(($totLum1+$totLum2+$totLum3)*0.14*6*30, 3)." €";?></p>
					<br /><hr /><br />
